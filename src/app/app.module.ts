...
@NgModule({
	declarations: [ AppComponent, LoginComponent, HomeComponent, RegisterComponent, TechItemComponent, MihneaComponent, HeaderComponent, ProjectTabComponent, CreateProjectComponent, UsersSuggestionsComponent, ProjectPageComponent ],
